...
tiff("D:\\flinders\\REMS the accuracy of diagnostic tests for Osteoporosis\\loo_fnd.tiff", width = 12.5, height = 10, units = "in", res = 600)
...
tiff("D:\\flinders\\REMS the accuracy of diagnostic tests for Osteoporosis\\loo_lumbar.tiff", width = 12.6, height = 12, units = "in", res = 600)
