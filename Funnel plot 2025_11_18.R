...
funnel_fnd<-ggplot() +
  ...
  labs(
    ...
    y = "Standard Error",
    title = "Begg's Rank Correlation Test for Funnel Plot Asymmetry (P=0.0866)\n Egger's Regression Based Test for Funnel Plot Asymmetry (P<0.0001)"
  ) +
...
funnel_lumbar<-ggplot() +
  ...
  labs(
    x = "Fisher’s z transformed correlation",
    y = "Standard Error",
    title = "Begg's Rank Correlation Test for Funnel Plot Asymmetry (P=0.2884)\n Egger's Regression Based Test for Funnel Plot Asymmetry (P=0.0354)"
  ) +
