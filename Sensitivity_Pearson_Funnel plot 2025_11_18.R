...
funnel_fnd<-ggplot() +
  ...
  labs(
    ...
    y = "Standard Error",
    title = "Begg's Rank Correlation Test for Funnel Plot Asymmetry (P=0.5619)\n Egger's Regression Based Test for Funnel Plot Asymmetry (P=0.0728)"
  ) +
...
ggsave(
  filename = "D:\\flinders\\REMS the accuracy of diagnostic tests for Osteoporosis\\sensitivity_Pearson_funnel_fnd.tiff",
  plot = funnel_fnd,
  device = "tiff",
  units = "mm",
...
funnel_lumbar<-ggplot() +
  ...
  labs(
    x = "Fisher’s z transformed correlation",
    y = "Standard Error",
    title = "Begg's Rank Correlation Test for Funnel Plot Asymmetry (P=0.5098)\n Egger's Regression Based Test for Funnel Plot Asymmetry (P=0.5058)"
  ) +
...
ggsave(
  filename = "D:\\flinders\\REMS the accuracy of diagnostic tests for Osteoporosis\\sensitivity_Pearson_funnel_lumbar.tiff",
  plot = funnel_lumbar,
  device = "tiff",
  units = "mm",
