...
funnel_fnd<-ggplot() +
  ...
  labs(
    ...
    y = "Standard Error",
    title = "Begg's Rank Correlation Test for Funnel Plot Asymmetry (P=1.000)\n Egger's Regression Based Test for Funnel Plot Asymmetry (P=0.1330)"
  ) +
...
ggsave(
  filename = "D:\\flinders\\REMS the accuracy of diagnostic tests for Osteoporosis\\sensitivity_hq_funnel_fnd.tiff",
  plot = funnel_fnd,
  device = "tiff",
  units = "mm",
...
funnel_lumbar<-ggplot() +
  ...
  labs(
    x = "Fisher’s z transformed correlation",
    y = "Standard Error",
    title = "Begg's Rank Correlation Test for Funnel Plot Asymmetry (P=0.9049)\n Egger's Regression Based Test for Funnel Plot Asymmetry (P=0.7628)"
  ) +
...
ggsave(
  filename = "D:\\flinders\\REMS the accuracy of diagnostic tests for Osteoporosis\\sensitivity_funnel_hq_lumbar.tiff",
  plot = funnel_lumbar,
  device = "tiff",
  units = "mm",
