...
tiff("D:\\flinders\\REMS the accuracy of diagnostic tests for Osteoporosis\\firuge1 forest_plot_fnd.tiff", width = 9, height = 6, units = "in", res = 600)
meta::forest(
  r.meta1,
  digits = 3,
  overall = TRUE,
...
tiff("D:\\flinders\\REMS the accuracy of diagnostic tests for Osteoporosis\\figure1 forest_plot_lumbar.tiff", width = 9, height = 8, units = "in", res = 600)
meta::forest(
  r.meta2,
  digits = 3,
  overall = TRUE,
